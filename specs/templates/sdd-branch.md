...
| Item | Regra |
|------|-------|
| Branch Git | `{tipo}/{ISSUE-KEY}` (ex.: `feat/PROJ-1234`) — ou `{tipo}/{slug}` sem issue tracker |
...
1. Propor o nome da branch de trabalho: `{tipo}/{ISSUE-KEY-ou-slug}`.
